...
height.plot <- ggplot(diff_times, aes(x = Height.m, y = diff)) + 
  ...
  geom_text(x=1.85, y=35, label="Faster at X-Ray", color = friendly_pal("contrast_three")[1], cex = 5) +
geom_text(x=1.85, y=-45, label="Faster at Map", color = friendly_pal("contrast_three")[2], cex = 5) 
ggsave(height.plot, 
...
hist.plot <- ggplot(all_data, aes(x = Presence)) +
  geom_histogram(binwidth = 1, color = "black", fill = "gray") +
  cust_theme_classic() +
  labs(x = "Presence Rating")+ 
  xlim(c(1,5.5)) +
